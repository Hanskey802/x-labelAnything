...
class LabelingWidget(LabelDialog):
    ...
    def __init__(  # noqa: C901
        ...
        export_xanylabeling_json_to_yolo = action(
            self.tr("批量转换 X-AnyLabeling JSON 到 YOLO"),
            lambda: utils.export_xanylabeling_json_to_yolo(self),
            None,
            icon="format_yolo",
            tip=self.tr(
                "将 X-AnyLabeling 的 JSON 标注批量转换为 YOLO 标签"
            ),
        )
        ...
        self.actions = utils.Struct(
            ...
            export_xanylabeling_json_to_yolo=export_xanylabeling_json_to_yolo,
            zoom=zoom,
            zoom_in=zoom_in,
            zoom_out=zoom_out,
            zoom_org=zoom_org,
        ...
        utils.add_actions(
            ...
            (
                ...
                None,
                export_xanylabeling_json_to_yolo,
            ),
        )
        utils.add_actions(
            self.menus.view,
